...
batch_size = 32
# Training patches
X_train_folder,Y_train_folder,v_train_folder,X_test_folder,Y_test_folder,v_test_folder, n_imgs,img_width, img_heigth1,n_test=mf.GetDRIVEPREAUG()
...
with open("model_Liskowski_augmented.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("model_Liskowski_augmented.h5")
